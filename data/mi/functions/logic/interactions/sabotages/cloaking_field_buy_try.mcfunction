...
execute if score $powerPlant map matches 1 if entity @s[team=team1] if score #team1 stock >= #cloaking price run function mi:maps/power_plant/interactions/sabotages/cloaking_field_buy_team1
execute if score $powerPlant map matches 1 if entity @s[team=team2] if score #team2 stock >= #cloaking price run function mi:maps/power_plant/interactions/sabotages/cloaking_field_buy_team2
