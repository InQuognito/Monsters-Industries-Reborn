...
# Join Team 2
execute positioned -28.5 6.5 -103.5 if block ~ ~ ~ #minecraft:buttons[powered=true] as @p run function mi:logic/teams/team2_join
...
# Join Spectators
execute positioned -24.5 6.5 -105.5 if block ~ ~ ~ #minecraft:buttons[powered=true] as @p run function mi:logic/teams/spectators_join
...
# Settings (From Lobby)
execute positioned -24.5 6.5 -111.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run tp @p -28.5 5.0 -119.5 180.0 0.0
...
# Lobby (From Settings)
execute positioned -28.5 6.5 -117.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run tp @p -28.5 5.0 -108.5 270.0 0.0
...
# Info (From Lobby)
execute positioned -24.5 6.5 -110.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run tp @p -28.5 5.0 -97.5 0.0 0.0
...
# Lobby (From Info)
execute positioned -28.5 6.5 -99.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run tp @p -28.5 5.0 -108.5 270.0 0.0
...
# Show My Stats
execute positioned -24.5 6.5 -106.5 if block ~ ~ ~ #minecraft:buttons[powered=true] as @p run function mi:logic/stats
...
# Start
execute positioned -24.5 6.5 -108.5 if block ~ ~ ~ #minecraft:buttons[powered=true] as @p run function mi:logic/start_check
