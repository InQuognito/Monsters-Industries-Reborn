...
execute if score #team2NeuronWorm temp matches 1 run summon minecraft:glow_item_frame 183.5 22.5 -151.5 {Tags:["team2","mobShop","neuronWorm"],Facing:3b,Fixed:1b,Invisible:1b,Invulnerable:1b,Item:{id:"minecraft:endermite_spawn_egg",Count:1b,tag:{CustomModelData:1,display:{Name:'{"text":"Neuron Worm"}'}}}}
