...
execute unless score #temp ct.paper >= #maxHealth3 price at @e[type=minecraft:marker,tag=inputs.objectMarker] run function mi:logic/interactions/team_upgrades/reset_input
