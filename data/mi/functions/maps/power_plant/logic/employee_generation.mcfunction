...
execute if score #team1 bankAccount matches 2 if score #team1 ct.paper < #paperMaxTeam1 vars run scoreboard players operation #team1 ct.paper += #employeeGain temp
...
execute if score #team2 bankAccount matches 2 if score #team2 ct.paper < #paperMaxTeam2 vars run scoreboard players operation #team2 ct.paper += #employeeGain temp
