...
execute if score $mode mode matches 0..1 positioned 205 20 -146 as @a[team=team2,scores={isDead=1..}] run function mi:logic/teams/death
...
scoreboard players set @a[team=team2,scores={isDead=1..}] isDead 0
