...
give @s[team=team2] minecraft:creeper_spawn_egg{display:{Name:'[{"text":"Creeper","italic":false,"color":"red"}]'},EntityTag:{id:"minecraft:creeper",Health:30,PersistenceRequired:1b,Tags:["newMob"],Attributes:[{Name:"generic.follow_range",Base:2048d},{Name:"generic.max_health",Base:30d}],Team:team2,DeathLootTable:"mi:entities/others/creeper"},CanPlaceOn:["smooth_quartz_slab","lapis_block"]} 1

title @s actionbar [{"text":"You have purchased ","color":"green"},{"text":"Creeper (x1)","color":"dark_green"},{"text":"!","color":"green"}]

function mi:logic/currency/reset_temp_prices
scoreboard players operation #clearPaper temp = #creeper1Paper price
scoreboard players operation #clearGunpowder temp = #creeper1Gunpowder price
