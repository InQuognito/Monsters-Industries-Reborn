...
execute if score #team1DirectDeposit timer matches 900.. run function mi:logic/interactions/sabotages/direct_deposit/off_team1
...
execute if score #team2DirectDeposit timer matches 900.. run function mi:logic/interactions/sabotages/direct_deposit/off_team2
