...
execute if score $powerPlant map matches 1 if entity @s[team=team1] if score #team1Interval forge matches ..10 if score #tokenCount temp >= #forgeIntervalTokens price if score #team1 ct.netherite >= #forgeIntervalNetherite price run function mi:maps/power_plant/logic/interactions/generators/forge_interval_buy_team1
execute if score $powerPlant map matches 1 if entity @s[team=team2] if score #team2Interval forge matches ..10 if score #tokenCount temp >= #forgeIntervalTokens price if score #team2 ct.netherite >= #forgeIntervalNetherite price run function mi:maps/power_plant/logic/interactions/generators/forge_interval_buy_team2
