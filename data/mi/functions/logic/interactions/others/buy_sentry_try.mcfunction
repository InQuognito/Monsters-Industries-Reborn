...
execute if score $powerPlant map matches 1 if entity @s[team=team1] if score #team1 sentryCount matches ..9 if score #tokenCount temp >= #sentry price run function mi:maps/power_plant/interactions/others/buy_sentry_team1
execute if score $powerPlant map matches 1 if entity @s[team=team2] if score #team2 sentryCount matches ..9 if score #tokenCount temp >= #sentry price run function mi:maps/power_plant/interactions/others/buy_sentry_team2
