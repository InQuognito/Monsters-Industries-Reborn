...
execute if entity @s[team=team1] run scoreboard players operation #team1 ct.paper -= #randomRecipe price
execute if entity @s[team=team2] run scoreboard players operation #team2 ct.paper -= #randomRecipe price
