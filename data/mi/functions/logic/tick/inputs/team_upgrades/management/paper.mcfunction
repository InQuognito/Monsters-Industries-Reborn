...
execute if entity @s[team=team1] run scoreboard players set #team1EmployeeResource employees 1
execute if entity @s[team=team2] run scoreboard players set #team2EmployeeResource employees 1
