...
setblock 132 22 -95 minecraft:birch_wall_sign[facing=west]{Color:"black",Text2:'{"text":"Equipment Malfunction","clickEvent":{"action":"run_command","value":"tellraw @s [\\"\\",{\\"text\\":\\"Equipment Malfunction\\",\\"color\\":\\"gold\\"},{\\"text\\":\\" - \\",\\"color\\":\\"dark_gray\\"},{\\"text\\":\\"Downgrades several random upgrades of the opponent\'s.\\",\\"color\\":\\"yellow\\"}]"}}',Text3:'[{"score":{"name":"#equipmentMalfunction","objective":"price"}},{"text":" Stock"}]'} destroy
...
setblock 148 22 -159 minecraft:spruce_wall_sign[facing=east]{Color:"black",Text2:'{"text":"Equipment Malfunction","clickEvent":{"action":"run_command","value":"tellraw @s [\\"\\",{\\"text\\":\\"Equipment Malfunction\\",\\"color\\":\\"gold\\"},{\\"text\\":\\" - \\",\\"color\\":\\"dark_gray\\"},{\\"text\\":\\"Downgrades several random upgrades of the opponent\'s.\\",\\"color\\":\\"yellow\\"}]"}}',Text3:'[{"score":{"name":"#equipmentMalfunction","objective":"price"}},{"text":" Stock"}]'} destroy
