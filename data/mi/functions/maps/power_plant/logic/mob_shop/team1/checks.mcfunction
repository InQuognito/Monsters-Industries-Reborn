...
execute if predicate mi:mob_shop_try_team1 if entity @e[tag=mobShopBuy,tag=zombie,tag=team1] run function mi:shop/mobs/zombies/zombie_buy_try
execute if predicate mi:mob_shop_try_team1 run fill 91 20 -99 92 22 -99 minecraft:birch_button[powered=false] replace
