execute positioned 176.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] if score #team2MobShop temp matches 1 run schedule function mi:maps/power_plant/logic/mob_shop/team2/load_zombies_skeletons 1t replace
...
execute positioned 179.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] if entity @e[tag=team2,tag=mobShop,tag=spider] run function mi:maps/power_plant/logic/mob_shop/team2/selection/spider
...
execute positioned 180.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] if entity @e[tag=team2,tag=mobShop,tag=caveSpider] run function mi:maps/power_plant/logic/mob_shop/team2/selection/cave_spider
...
execute positioned 181.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] if entity @e[tag=team2,tag=mobShop,tag=creeper] run function mi:maps/power_plant/logic/mob_shop/team2/selection/creeper
...
execute positioned 182.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] if entity @e[tag=team2,tag=mobShop,tag=slime] run function mi:maps/power_plant/logic/mob_shop/team2/selection/slime
...
execute positioned 183.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function mi:maps/power_plant/logic/mob_shop/team2/selection/phantom
...
execute positioned 184.5 21.5 -151.5 if block ~ ~ ~ #minecraft:buttons[powered=true] run function mi:maps/power_plant/logic/mob_shop/team2/selection/villager
