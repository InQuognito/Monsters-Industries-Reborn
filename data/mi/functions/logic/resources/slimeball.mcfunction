...
execute if score #temp bankAccount matches 1 if score @s ct.slimeball < #slimeballMax vars run scoreboard players operation @s ct.slimeball += #temp production.slimeball
execute if score #temp bankAccount matches 2 if score #temp ct.slimeball < #slimeballMaxScaled vars run scoreboard players operation #add ct.slimeball = #temp production.slimeball
execute if score #temp bankAccount matches 3 run scoreboard players operation #add ct.slimeball = #temp production.slimeball
