...
execute if score #team1 bankAccount matches 1 run scoreboard players operation @s[team=team1] ct.bones -= #clearBone price
execute if score #team1 bankAccount matches 1 run scoreboard players operation @s[team=team1] ct.spiderEyes -= #clearSpiderEye price
...
execute if score #team1 bankAccount matches 1 run scoreboard players operation @s[team=team1] ct.slimeballs -= #clearSlimeball price
...
execute if score #team2 bankAccount matches 1 run scoreboard players operation @s[team=team2] ct.bones -= #clearBone price
execute if score #team2 bankAccount matches 1 run scoreboard players operation @s[team=team2] ct.spiderEyes -= #clearSpiderEye price
...
execute if score #team2 bankAccount matches 1 run scoreboard players operation @s[team=team2] ct.slimeballs -= #clearSlimeball price
...
execute if score #team1 bankAccount matches 2..3 if entity @s[team=team1] run scoreboard players operation #team1 ct.bones -= #clearBone price
execute if score #team1 bankAccount matches 2..3 if entity @s[team=team1] run scoreboard players operation #team1 ct.spiderEyes -= #clearSpiderEye price
...
execute if score #team1 bankAccount matches 2..3 if entity @s[team=team1] run scoreboard players operation #team1 ct.slimeballs -= #clearSlimeball price
...
execute if score #team2 bankAccount matches 2..3 if entity @s[team=team2] run scoreboard players operation #team2 ct.bones -= #clearBone price
execute if score #team2 bankAccount matches 2..3 if entity @s[team=team2] run scoreboard players operation #team2 ct.spiderEyes -= #clearSpiderEye price
...
execute if score #team2 bankAccount matches 2..3 if entity @s[team=team2] run scoreboard players operation #team2 ct.slimeballs -= #clearSlimeball price
