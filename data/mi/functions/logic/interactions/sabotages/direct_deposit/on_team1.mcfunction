...
execute at @e[type=minecraft:marker,tag=location.directDeposit.team1.spawner] positioned ~-1 ~4 ~ run function mi:logic/interactions/sabotages/direct_deposit/chain_team1
