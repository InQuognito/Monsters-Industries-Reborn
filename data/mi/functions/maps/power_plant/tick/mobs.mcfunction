...
execute as @e[type=#mi:mobs,team=team2,x=139,y=19,z=-171,dx=0,dy=13,dz=88] at @s run tp @s ~-0.5 ~ ~
execute as @e[type=#mi:mobs,team=team1,x=141,y=19,z=-171,dx=0,dy=13,dz=88] at @s run tp @s ~0.5 ~ ~
