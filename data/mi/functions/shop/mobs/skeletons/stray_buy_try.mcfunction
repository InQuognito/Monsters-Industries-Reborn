...
execute unless score #temp ct.bones >= #bonePrice temp run title @s actionbar [{"text":"You don't have enough bones to purchase this many ","color":"red"},{"text":"Strays","color":"dark_gray"},{"text":"!","color":"red"}]
execute unless score #temp ct.spiderEyes >= #spiderEyePrice temp run title @s actionbar [{"text":"You don't have enough spider eyes to purchase this many ","color":"red"},{"text":"Strays","color":"dark_gray"},{"text":"!","color":"red"}]
execute if score #temp ct.paper >= #paperPrice temp if score #temp ct.bones >= #bonePrice temp if score #temp ct.spiderEyes >= #spiderEyePrice temp run function mi:shop/mobs/skeletons/stray_buy
