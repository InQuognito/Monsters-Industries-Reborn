...
execute unless score $temp stock >= #securityBreach price run title @s actionbar [{"text":"You do not have enough stock to summon the ","color":"red"},{"text":"Wither","color":"white"},{"text":"!","color":"red"}]
