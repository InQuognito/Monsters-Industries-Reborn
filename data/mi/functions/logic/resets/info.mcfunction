...
setblock -27 6 -87 minecraft:birch_wall_sign[facing=west]{Text1:'{"text":"","clickEvent":{"action":"run_command","value":"/execute as @p run function mi:logic/info/resources/bones"}}',Text2:'{"text":"Bones"}'} destroy
...
setblock -27 5 -88 minecraft:birch_wall_sign[facing=west]{Text1:'{"text":"","clickEvent":{"action":"run_command","value":"/execute as @p run function mi:logic/info/resources/spider_eyes"}}',Text2:'{"text":"Spider Eyes"}'} destroy
setblock -27 5 -87 minecraft:birch_wall_sign[facing=west]{Text1:'{"text":"","clickEvent":{"action":"run_command","value":"/execute as @p run function mi:logic/info/resources/slimeballs"}}',Text2:'{"text":"Slimeballs"}'} destroy
