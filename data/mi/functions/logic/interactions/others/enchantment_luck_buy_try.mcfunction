...
execute if score $powerPlant map matches 1 if entity @s[team=team1] if score #team1 ct.paper >= #enchantmentLuckPaper price if score #team1 ct.netherite >= #enchantmentLuckNetherite price run function mi:maps/power_plant/logic/interactions/others/enchantment_luck_buy_team1
execute if score $powerPlant map matches 1 if entity @s[team=team2] if score #team2 ct.paper >= #enchantmentLuckPaper price if score #team2 ct.netherite >= #enchantmentLuckNetherite price run function mi:maps/power_plant/logic/interactions/others/enchantment_luck_buy_team2
