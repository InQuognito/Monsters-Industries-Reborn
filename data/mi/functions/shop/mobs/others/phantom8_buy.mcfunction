...
give @s[team=team2] minecraft:phantom_spawn_egg{display:{Name:'[{"text":"Phantom","italic":false,"color":"red"}]'},EntityTag:{id:"minecraft:phantom",Health:25,PersistenceRequired:1b,Tags:["newMob"],Attributes:[{Name:"minecraft:generic.follow_range",Base:2048d},{Name:"minecraft:generic.max_health",Base:25d}],Team:team2,DeathLootTable:"mi:entities/others/phantom"},CanPlaceOn:["smooth_quartz_slab","lapis_block"]} 8
