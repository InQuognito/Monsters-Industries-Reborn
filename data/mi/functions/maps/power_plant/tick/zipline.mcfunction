execute if block 110 27 -124 smooth_stone_slab[type=double] as @e[dx=1,dy=2,dz=1,tag=!inZipline1,team=team1,type=!arrow,type=!firework_rocket,type=!item,type=!minecart,type=!player,type=!trident,type=!wither,x=110,y=28,z=-124] run tag @s add inZipline1
...
execute if block 170 27 -127 smooth_quartz_slab[type=double] as @e[dx=1,dy=2,dz=1,tag=!inZipline2,team=team2,type=!arrow,type=!firework_rocket,type=!item,type=!minecart,type=!player,type=!trident,type=!wither,x=170,y=28,z=-127] run tag @s add inZipline2
