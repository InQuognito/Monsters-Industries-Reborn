...
execute if score $powerPlant map matches 1 if entity @s[team=team1] if score #team1 stock >= #plague price run function mi:maps/power_plant/logic/interactions/sabotages/plague_buy_team1
execute if score $powerPlant map matches 1 if entity @s[team=team2] if score #team2 stock >= #plague price run function mi:maps/power_plant/logic/interactions/sabotages/plague_buy_team2
