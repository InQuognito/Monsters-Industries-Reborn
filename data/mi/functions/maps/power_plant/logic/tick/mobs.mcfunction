...
execute if score $speedMode mode matches 1 if entity @e[tag=newMob,team=team1] run scoreboard players add #team1 stock 1
execute if score $speedMode mode matches 1 if entity @e[tag=newMob,team=team2] run scoreboard players add #team2 stock 1
