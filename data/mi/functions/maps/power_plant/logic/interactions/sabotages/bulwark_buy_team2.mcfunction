...
execute as @e[type=minecraft:iron_golem,team=team2] run attribute @s minecraft:generic.armor modifier add 11111111-1111-1111-1111-111111111112 "bulwark" 15 add
