...
schedule function mi:logic/interactions/sabotages/cloaking_field/remove_team1 45s
schedule function mi:maps/power_plant/logic/interactions/sabotages/cloaking_field/cooldown_team1 300s
