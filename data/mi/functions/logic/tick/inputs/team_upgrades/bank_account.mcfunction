...
execute if score #bankAccount temp matches 0 run function mi:logic/interactions/team_upgrades/bank_account/personal/try
execute if score #bankAccount temp matches 1 run function mi:logic/interactions/team_upgrades/bank_account/shared/try
execute if score #bankAccount temp matches 2 run function mi:logic/interactions/team_upgrades/bank_account/unlimited/try
