...
execute if score #team1 sentryCount matches 1..9 run summon iron_golem 131 19 -126 {CustomName:'[{"text":"Sentry","color":"aqua"}]',Health:150,PersistenceRequired:1b,Attributes:[{Name:"generic.follow_range",Base:2048f},{Name:"generic.max_health",Base:150f}],Team:team1}
execute if score #team1 sentryCount matches 10 run summon iron_golem 131 19 -126 {CustomName:'[{"text":"Veteran Sentry","color":"aqua"}]',Invulnerable:1b,PersistenceRequired:1b,Attributes:[{Name:"generic.follow_range",Base:2048f}],Team:team1}
