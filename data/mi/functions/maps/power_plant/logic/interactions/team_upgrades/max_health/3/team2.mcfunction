...
data merge block 205 20 -146 {Text2:'{"text":"[ 3 / 5 ]"}',Text3:'[{"score":{"name":"#maxHealth4Paper","objective":"price"}},{"text":" Paper"}]',Text4:'[{"score":{"name":"#maxHealth4Slimeball","objective":"price"}},{"text":" Slimeballs"}]'}
