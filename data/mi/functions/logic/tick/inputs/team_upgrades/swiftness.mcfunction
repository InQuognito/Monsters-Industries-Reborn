...
execute if score #swiftness temp matches 0 run function mi:logic/interactions/team_upgrades/swiftness/1/try
execute if score #swiftness temp matches 1 run function mi:logic/interactions/team_upgrades/swiftness/2/try
execute if score #swiftness temp matches 2 run function mi:logic/interactions/team_upgrades/swiftness/3/try
