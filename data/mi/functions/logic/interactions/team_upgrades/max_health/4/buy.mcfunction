...
data merge block ^ ^1 ^ {Color:"black",Text2:'{"text":"[ 4 / 5 ]"}',Text3:'[{"score":{"name":"#maxHealth5","objective":"price"}},{"text":" Paper"}]'}
...
scoreboard players operation #clearPaper temp = #maxHealth4 price
