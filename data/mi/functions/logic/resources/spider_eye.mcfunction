...
execute if score #temp bankAccount matches 1 if score @s ct.spiderEye < #spiderEyeMax vars run scoreboard players operation @s ct.spiderEye += @s production.spiderEyes
execute if score #temp bankAccount matches 2 if score #temp ct.spiderEye < #spiderEyeMaxScaled vars run scoreboard players operation #add ct.spiderEye = @s production.spiderEyes
