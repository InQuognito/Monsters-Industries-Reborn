...
execute if score #maxHealth temp matches 0 run function mi:logic/interactions/team_upgrades/max_health/1/try
execute if score #maxHealth temp matches 1 run function mi:logic/interactions/team_upgrades/max_health/2/try
execute if score #maxHealth temp matches 2 run function mi:logic/interactions/team_upgrades/max_health/3/try
execute if score #maxHealth temp matches 3 run function mi:logic/interactions/team_upgrades/max_health/4/try
execute if score #maxHealth temp matches 4 run function mi:logic/interactions/team_upgrades/max_health/5/try
