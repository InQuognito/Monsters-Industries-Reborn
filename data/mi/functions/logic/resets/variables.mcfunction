...
# Book - Mobs
scoreboard players set #zombie1Paper price 8
scoreboard players operation #mult temp = #zombie1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #zombie8Paper price = #mult temp
scoreboard players operation #zombieCPaper price = #mult temp
scoreboard players set #zombie1Coal price 4
scoreboard players operation #mult temp = #zombie1Coal price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #zombie8Coal price = #mult temp
scoreboard players operation #zombieCCoal price = #mult temp

scoreboard players set #husk1Paper price 12
scoreboard players operation #mult temp = #husk1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #husk8Paper price = #mult temp
scoreboard players operation #huskCPaper price = #mult temp
scoreboard players set #husk1Coal price 6
scoreboard players operation #mult temp = #husk1Coal price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #husk8Coal price = #mult temp
scoreboard players operation #huskCCoal price = #mult temp
scoreboard players set #husk1SpiderEyes price 1
scoreboard players operation #mult temp = #husk1SpiderEyes price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #husk8SpiderEyes price = #mult temp
scoreboard players operation #huskCSpiderEyes price = #mult temp

scoreboard players set #skeleton1Paper price 24
scoreboard players operation #mult temp = #skeleton1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #skeleton8Paper price = #mult temp
scoreboard players set #skeleton1Bones price 6
scoreboard players operation #mult temp = #skeleton1Bones price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #skeleton8Bones price = #mult temp

scoreboard players set #stray1Paper price 32
scoreboard players operation #mult temp = #stray1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #stray8Paper price = #mult temp
scoreboard players operation #strayCPaper price = #mult temp
scoreboard players set #stray1Bones price 8
scoreboard players operation #mult temp = #stray1Bones price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #stray8Bones price = #mult temp
scoreboard players operation #strayCBones price = #mult temp
scoreboard players set #stray1SpiderEyes price 1
scoreboard players operation #mult temp = #stray1SpiderEyes price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #stray8SpiderEyes price = #mult temp
scoreboard players operation #strayCSpiderEyes price = #mult temp

scoreboard players set #spider1Paper price 8
scoreboard players operation #mult temp = #spider1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #spider8Paper price = #mult temp
scoreboard players set #spider1SpiderEyes price 4
scoreboard players operation #mult temp = #spider1SpiderEyes price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #spider8SpiderEyes price = #mult temp

scoreboard players set #caveSpider1Paper price 32
scoreboard players operation #mult temp = #caveSpider1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #caveSpider8Paper price = #mult temp
scoreboard players set #caveSpider1SpiderEyes price 8
scoreboard players operation #mult temp = #caveSpider1SpiderEyes price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #caveSpider8SpiderEyes price = #mult temp
scoreboard players set #caveSpider1Gunpowder price 2
scoreboard players operation #mult temp = #caveSpider1Gunpowder price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #caveSpider8Gunpowder price = #mult temp

scoreboard players set #creeper1Paper price 48
scoreboard players operation #mult temp = #creeper1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #creeper8Paper price = #mult temp
scoreboard players set #creeper1Gunpowder price 12
scoreboard players operation #mult temp = #creeper1Gunpowder price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #creeper8Gunpowder price = #mult temp

scoreboard players set #slime1Paper price 64
scoreboard players operation #mult temp = #slime1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #slime8Paper price = #mult temp
scoreboard players set #slime1Slimeballs price 16
scoreboard players operation #mult temp = #slime1Slimeballs price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #slime8Slimeballs price = #mult temp

scoreboard players set #phantom1Paper price 128
scoreboard players operation #mult temp = #phantom1Paper price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #phantom8Paper price = #mult temp
scoreboard players set #phantom1Slimeballs price 24
scoreboard players operation #mult temp = #phantom1Slimeballs price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #phantom8Slimeballs price = #mult temp
scoreboard players set #phantom1Gunpowder price 16
scoreboard players operation #mult temp = #phantom1Gunpowder price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #phantom8Gunpowder price = #mult temp

scoreboard players set #villager1 price 128
scoreboard players operation #mult temp = #villager1 price
scoreboard players operation #mult temp *= #8 integers
scoreboard players operation #villagerC price = #mult temp
...
scoreboard players set #plague price 250
...
scoreboard players set #directDeposit price 300
...
scoreboard players set #summonWither price 350
...
scoreboard players set #nuke price 400
...
scoreboard players set #cloaking price 100
...
scoreboard players set #bulwark price 100
...
scoreboard players set #directExposure price 125
