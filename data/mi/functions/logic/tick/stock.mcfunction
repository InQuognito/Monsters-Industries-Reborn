execute as @a[team=team1,scores={isDead=1..}] run function mi:logic/teams/team1_death
execute as @a[team=team2,scores={isDead=1..}] run function mi:logic/teams/team2_death
