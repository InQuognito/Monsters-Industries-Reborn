give @s[team=team1] ravager_spawn_egg{display:{Name:'[{"text":"Ravager","italic":false,"color":"aqua"}]'},EntityTag:{id:"minecraft:ravager",Health:75,PersistenceRequired:1b,Tags:["newMob"],Attributes:[{Name:"generic.follow_range",Base:2048d},{Name:"generic.max_health",Base:75d}],Team:team1},CanPlaceOn:["smooth_stone_slab"]} 1
give @s[team=team2] ravager_spawn_egg{display:{Name:'[{"text":"Ravager","italic":false,"color":"red"}]'},EntityTag:{id:"minecraft:ravager",Health:75,PersistenceRequired:1b,Tags:["newMob"],Attributes:[{Name:"generic.follow_range",Base:2048d},{Name:"generic.max_health",Base:75d}],Team:team2},CanPlaceOn:["smooth_quartz_slab"]} 1
